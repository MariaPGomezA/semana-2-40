<template>
    <nav class="navbar navbar-light nav-justified navbar-expand-lg sticky-top " style="background-color: #2F6BA1;">
        <a class="navbar-brand ml-5" href="index.html">
            <svg width="3em" height="3em" viewBox="0 0 16 16" class="bi bi-film" fill="currentColor"
        ...
        <div class="d-flex flex-row justify-content-center">
            <a href="" class="btn btn-primary mr-3 ">Facebook</a>
